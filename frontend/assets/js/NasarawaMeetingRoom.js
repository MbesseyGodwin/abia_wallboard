...
jQuery(document).ready(function($) {
    var arraw = $("#arraw");
    let expected = 6750; // 120275; //Update this To reflect the Updated TxNew for the state
    setInterval(() => {
    ...
    datasets: [
        ...
        },
        {
          label: 'Target Projection',
            ...
            data: [35899,38438,40977,43516,46055,48594,51134,53673,56212,58751,61290,63829],           
            borderWidth: 1,
            xAxisID: "bar-x-axis1",
            stack: "background"
        }
	  ...
	  success(data) {
		...
		let myChart2 = new Chart(ctx, {
		  ...
		  data: {
			...
			datasets: [
			  {
				label: "# of Positive Identified (Cummulative)",
				data: newsumTxData,
				lineTension: 0,
				backgroundColor: [
